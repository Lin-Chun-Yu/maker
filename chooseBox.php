...
<!DOCTYPE html>
    ...
    <body style = "background-color:#74A709;"> 
        <!-- top navigation -->
        <div class="top_nav">
            <div class="nav_menu">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    ...
                    <div class="modal-body" id = "body">
                        <p align = "center" style = "margin:0px">
                            ...
                            <span style = "font-size:0.8em">如果是，櫃子將開啟10秒，請盡速放置物品，並關上櫃門</span>
                        </p>
                    </div>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    ...
                    <div class="modal-body" id = "body" style = "padding-left:2px;padding-right:2px;">
                        <p align = "center" style = "vertical-align:middle;margin:0px">
                            櫃門已開啟，請於10秒內放好物品，並將櫃門關上
                        </p>
                        <p align = "center" style = "vertical-align:middle;margin:0px">
                            櫃門還剩&nbsp<span style = "font-size:2em" id = "second">10</span>&nbsp秒關上
                        </p>
