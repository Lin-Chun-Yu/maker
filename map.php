                                ...
                                <tr>
                                    <td align = "center">
                                        <div style = "position:relative;">
                                            ...
                                            <div>
                                                <img src = "building1.png" href = "./building1.png" style = "width:5%;position:absolute;top:35%;left:22.5%" onclick = "choose(1)">
                                            </div>
                                            <div>
                                                <img src = "building2.png" href = "./building2.png" style = "width:8%;position:absolute;top:14%;left:38%" onclick = "choose(2)">
                                            </div>
                                            <div>
                                                <img src = "building3.png" href = "./building3.png" style = "width:5.5%;position:absolute;top:34.5%;left:39.5%" onclick = "choose(3)">
                                            </div>
                                            <div>
                                                <img src = "building5.png" href = "./building5.png" style = "width:11.5%;position:absolute;top:15%;left:25%" onclick = "choose(5)">
                                            </div>
                                            <div>
                                                <img src = "building6.png" href = "./building6.png" style = "width:4.3%;position:absolute;top:19%;left:19.5%" onclick = "choose(6)">
                                            </div>
                                            <div>
                                                <img src = "building7.png" href = "./building7.png" style = "width:10%;position:absolute;top:34%;left:44.5%" onclick = "choose(7)">
                                            </div>
                                        </div>
                                    </td>
                                </tr>
